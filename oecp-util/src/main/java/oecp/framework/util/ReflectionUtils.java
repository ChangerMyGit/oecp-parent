...
public abstract class ReflectionUtils {
	...
	public static Object getFieldValue(final Object obj, final String fieldName) {
		...
		Object result = null;
		if (field == null) {
			return invokeGetterMethod(obj, fieldName);
		}

		try {
			result = field.get(obj);
			if (result == null) {// 属性如果为null，再去找getter
				result = invokeGetterMethod(obj, fieldName);
			}
	...
	/**
	 * 设置字段的值，字段名可以是 xxx.xx.yyy这样的形式。
	 * @author slx
	 * @date 2013-11-15下午1:59:57
	 * @param obj
	 * @param fieldName
	 * @return
	 */
	public static Object getFieldValueInDeep(final Object obj, final String fieldName) {
		String[] fieldnames = fieldName.split("\\.");
		Object result = null;
		Object obj_current = obj;
		for (String fn : fieldnames) {
			result = getFieldValue(obj_current,fn);
			obj_current = result;
		}
		return result;
	}
	 ...
	 * 设置字段的值，字段名可以是 xxx.xx.yyy这样的形式。
	 * @author slx
	 * @date 2013-11-15下午2:00:37
	 * @param obj
	 * @param fieldName
	 * @param value
	 */
	public static void setFieldValueInDeep(final Object obj, final String fieldName, final Object value) {
		String[] fieldnames = fieldName.split("\\.");
		Object obj_current = obj;
		for (int i=0 ; i<fieldnames.length-1;i++) {
			obj_current = getFieldValue(obj_current,fieldnames[i]);
		}
		setFieldValue(obj_current, fieldnames[fieldnames.length-1], value);
	}
	
	public static Object getFieldValueInDeepet(final Object obj, final String fieldName){
		String[] fieldnames = fieldName.split("\\.");
		Object obj_current = obj;
