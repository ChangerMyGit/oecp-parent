...
import oecp.framework.util.web.ServletUtils;
...
public abstract class Struts2Utils {
	...
	public static final String CLUSTER_SESSION_CACHE = "_CLUSTER_SESSION_CACHE";

	private static ObjectMapper mapper = new ObjectMapper();

	/**
	 * 得到可以支持集群的SESSION. <br>
	 * 传统的httpsession和struts2的sessionMap不能很好的支持负载集群，该方法提供支持集群的session操作。<br>
	 * 该实现是通过EHCache作为分布式缓存的，如果需要支持分布式session，需要配置EHCache的分布式方式。
	 * 
	 * @author yongtree
	 * @date 2011-4-28 下午03:48:30
	 * @return
	 */
	@SuppressWarnings("unchecked")
//	public static Map<String,Serializable> getClusterSession() {
//		String sessionId = getSession()
//				.getId();
//		HashMap<String,Serializable> us = (HashMap<String,Serializable>) CacheManager.get(CLUSTER_SESSION_CACHE,
//				sessionId);
//		if (us == null) {
//			us = new HashMap<String,Serializable>();
//			CacheManager.set(CLUSTER_SESSION_CACHE, sessionId, us);
//		}
//		return us;
//
//	}
