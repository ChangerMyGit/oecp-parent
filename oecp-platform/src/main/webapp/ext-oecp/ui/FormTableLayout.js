Ext.ns("OECP.layout");
OECP.layout.FormTableLayout=Ext.extend(Ext.layout.ContainerLayout,{
 // private
 monitorResize:false,
  ...
  */    
    ...
    setContainer : function(ct){
        OECP.layout.FormTableLayout.superclass.setContainer.call(this, ct);
        this.currentRow = 0;
      ...
      if(!td){
       ...
       return;
         ...
         if(c.isFormField && c.inputType != 'hidden'){
             ...
             //OECP.layout.FormTableLayout.superclass.renderItem.apply(this, arguments);
...
Ext.Container.LAYOUTS['formtable'] = OECP.layout.FormTableLayout;