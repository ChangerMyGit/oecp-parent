 ...
 * @extends Ext.Panel
 */
OECP.bulletin.BulletinView = Ext.extend(Ext.Panel, {
	id : 'OECP.bulletin.BulletinView',
	layout : 'border',
	title : '公告发布1',
	...
	initComponent : function(){
		...
		master.store.removeAll();
		master.store.load();
		OECP.bulletin.BulletinView.superclass.initComponent.call(this);
	},
	/**
	 * 初始化表单
	 */
