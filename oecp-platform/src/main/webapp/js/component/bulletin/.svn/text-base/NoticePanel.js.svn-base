 ...
 * @extends Ext.Panel
 */
OECP.notice.NoticePanel = Ext.extend(Ext.Panel, {
	id : 'OECP.notice.NoticePanel',
	title : '公告信息',
	layout : 'fit',
...
//	            },
	            {
	            	...
	            	boxLabel: '是否下级公司可见',
	                name: 'notice.discorp',
	                inputValue:OECP.notice.StaticParam.noticeTypecorp
	            },
//	            {
//	                fieldLabel: '任务插件方法名称',
...
//		            },
		...
		OECP.notice.NoticePanel.superclass.initComponent.call(this);
	},
	/**
	 * 获取预警信息form的数据
	 * @return {}
