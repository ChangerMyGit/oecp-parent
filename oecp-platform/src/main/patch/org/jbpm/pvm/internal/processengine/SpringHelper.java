...
/**
 * 扩展SpringHelper，支持注入hibernate session factory
 * @author Joram Barrez
 * @author Huisheng Xu
 * @author yongtree
 */
public class SpringHelper implements ApplicationContextAware, DisposableBean {
  ...
  protected Object hibernateSessionFactory;
  ...
  public ProcessEngine createProcessEngine() {
    processEngine = new ConfigurationImpl()
      ...
      .setResource(jbpmCfg)
      .setHibernateSessionFactory(hibernateSessionFactory)
      .buildProcessEngine();
  ...
  public void setHibernateSessionFactory(Object hibernateSessionFactory) {
