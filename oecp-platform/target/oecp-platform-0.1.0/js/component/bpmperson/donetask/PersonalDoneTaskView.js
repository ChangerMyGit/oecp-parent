 ...
 */
Ext.ns("OECP.bpmperson.donetask");
 ...
 * 
 * @author yangtao
 * @class OECP.bpmperson.PersonalDoneTaskView 
 * @extends Ext.Panel
 */
OECP.bpmperson.PersonalDoneTaskView =  Ext.extend(Ext.Panel, {
	/**
	 * id
	 */
	id : 'PersonalDoneTaskViewForLogin',
	/**
	 * 标题
	 */
	title : "流程已办任务列表",
	...
	initComponent : function() {
		 ...
		 * 初始化父类
		 */
		OECP.bpmperson.PersonalDoneTaskView.superclass.initComponent.call(this);
		...
		this.store = new Ext.data.JsonStore({
			url :__fullPath+"bpm/person/task/doneTask.do",
			baseParams : {
						billInfo : "",
						beginTime : "",
						endTime : "",
